...
public class HinhAnhJDialog extends javax.swing.JDialog {

    public HinhAnhJDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        init();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Quản Lý Hình Ảnh");
        ...
        lblHinhAnh.setBackground(new java.awt.Color(204, 204, 255));
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(15, 15, 15)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(lblHinhAnh, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 180, Short.MAX_VALUE)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(jLabel5)
                                .addGap(0, 0, Short.MAX_VALUE)))))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HinhAnhJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                HinhAnhJDialog dialog = new HinhAnhJDialog(new javax.swing.JFrame(), true);
    ...
    private final HinhAnhService service = new HinhAnhService();
    private int row = -1;
    private int pages = 1;
    ...
    private Integer getPages(List<HinhAnh> listPag) {
    ...
    private void fillTable() {
        ...
        List<HinhAnh> listPag = service.selectAll();
        this.getPages(listPag);

        List<HinhAnh> listTable = service.selectPages(pages, limit);
    ...
    private void setForm(HinhAnh entity) {
        if (entity.getTen() != null) {
            lblHinhAnh.setToolTipText(entity.getTen());
            lblHinhAnh.setIcon(XImage.read(entity.getTen()));
        }
    }

    private HinhAnh getForm() {
        HinhAnh entity = new HinhAnh();
        entity.setTen(lblHinhAnh.getToolTipText());
    ...
    private void edit() {
        ...
        HinhAnh entity = service.selectById(id);
        this.setForm(entity);
    }
