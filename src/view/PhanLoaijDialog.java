...
public class PhanLoaijDialog extends javax.swing.JDialog {
    ...
    public PhanLoaijDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        init();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Quản Lý Phân Loại");
        ...
        tblPhanLoai.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
    ...
    private void tblPhanLoaiMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblPhanLoaiMouseClicked
        // TODO add your handling code here:
        this.row = tblPhanLoai.getSelectedRow();
        this.edit();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PhanLoaijDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PhanLoaijDialog dialog = new PhanLoaijDialog(new javax.swing.JFrame(), true);
    ...
    private final PhanLoaiService service = new PhanLoaiService();
    private int row = -1;
    private int pages = 1;
    ...
    private Integer getPages(List<PhanLoai> listPag) {
    ...
    private void fillTable() {
        DefaultTableModel tableModel = (DefaultTableModel) tblPhanLoai.getModel();
        tableModel.setRowCount(0);

        List<PhanLoai> listPag = service.selectAll();
        this.getPages(listPag);

        List<PhanLoai> listTable = service.searchPages(pages, limit);
    ...
    private void setForm(PhanLoai pl) {
        txtTen.setText(pl.getTen());
    }

    private PhanLoai getForm() {
    ...
    private void edit() {
        Integer id = (Integer) tblPhanLoai.getValueAt(row, 0);
        PhanLoai pl = service.selectById(id);
        this.setForm(pl);
    }
