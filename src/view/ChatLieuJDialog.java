...
public class ChatLieuJDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        tblChatLieu.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
    ...
    private void tblChatLieuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblChatLieuMouseClicked
        // TODO add your handling code here:
        this.row = tblChatLieu.getSelectedRow();
        this.edit();
    ...
    private Integer getPages(List<ChatLieu> listPag) {
    ...
    private void fillTable() {
        DefaultTableModel tableModel = (DefaultTableModel) tblChatLieu.getModel();
        tableModel.setRowCount(0);

        List<ChatLieu> listPag = service.selectAll();
        this.getPages(listPag);

        List<ChatLieu> listTable = service.selectPages(pages, limit);
    ...
    private void setForm(ChatLieu cl) {
    ...
    private void edit() {
        Integer id = (Integer) tblChatLieu.getValueAt(row, 0);
